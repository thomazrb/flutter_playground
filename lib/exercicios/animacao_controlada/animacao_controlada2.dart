...
import 'package:flutter_playground/exercicios/animacao_controlada/components/list_item2.dart';

class AnimacaoControlada2 extends StatefulWidget {
  const AnimacaoControlada2({super.key});

  @override
  State<AnimacaoControlada2> createState() => _AnimacaoControlada2State();
}

class _AnimacaoControlada2State extends State<AnimacaoControlada2> {
  String text =
